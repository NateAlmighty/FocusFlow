...
import sty from "./PlasmicButton.module.css"; // plasmic-import: nQAzkSlk0HL0/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__fndDb, {
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__ahAo, {
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__djgv)}
                role={"img"}
              />
            ),
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__dnnTv)}
                role={"img"}
              />
            ),
