...
import sty from "./PlasmicModal.module.css"; // plasmic-import: e0ng8ipOCA27/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_H0Um83gx-MyO"]]: true })}
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__s8ZdW)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {$props.showFooter ? (
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__ht7G)}
                    >
                      <Button
                        color={"muted"}
                        label={
