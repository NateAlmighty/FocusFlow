...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: trR-dZObjWEJ/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__w6Bm8)}>
        <div className={classNames(projectcss.all, sty.freeBox___7RpJ8)} />
      </div>
      {renderPlasmicSlot({
